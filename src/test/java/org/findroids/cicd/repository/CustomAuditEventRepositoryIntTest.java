package org.findroids.cicd.repository;

import org.findroids.cicd.JhipsterCdApp;
import org.findroids.cicd.config.Constants;
import org.findroids.cicd.config.audit.AuditEventConverter;
import org.findroids.cicd.domain.PersistentAuditEvent;
...
import static org.findroids.cicd.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
